...
interface BomComponentListSortingProps {
  sortBy: string;
...
export const BomComponentListSorting = ({
  sortBy,
  handleSortByChange,
  toggleSortDirection,
  sortDirection,
}: BomComponentListSortingProps) => {
  return (
    <>
      <Select value={sortBy} onValueChange={handleSortByChange}>
        ...
        <SelectContent>
          <SelectGroup>
            {bomComponentSortOptions.map((option) => (

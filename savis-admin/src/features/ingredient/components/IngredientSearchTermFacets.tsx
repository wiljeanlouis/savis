...
import { useIngredientSearchTermFacets } from "../hooks/useIngredientSearchTermFacets";

interface IngredientSearchTermFacetsProps {
  selectedSearchTerm?: string;
  onSearchTermChange: (searchTerm: string | undefined) => void;
}

export const IngredientSearchTermFacets = ({
  selectedSearchTerm,
  onSearchTermChange,
}: IngredientSearchTermFacetsProps) => {
  const {
    facets,
    filteredFacets,
    searchQuery,

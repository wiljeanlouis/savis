        ...
        <div className="flex h-screen items-center justify-center bg-gray">
            ...
            <div className="flex flex-col">
                <div className="flex items-center justify-center">
                    <div className="w-xs" >
                        <img src="/src/assets/savour_et_plus_logo.png" alt="logo savouretplus" />
                    </div>
                </div>
                <p className="text-2xl flex items-center justify-center">Bienvenue dans l'espace admin de SAVIS</p>
